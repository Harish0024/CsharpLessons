...
namespace FirstMVCApp.Controllers
{
	public class HomeController : Controller
	{
		...
		public IActionResult Mul(int x, int y)//Iaction is a html
		{
			int result = x * y;
			ViewData["result"] = result;
			return View("Add");//it is a inbuld function it will automatically makes view
		}
		public IActionResult Div(int x, int y)//Iaction is a html
		{
			int result = x / y;
			ViewData["result"] = result;
			return View("Add");//it is a inbuld function it will automatically makes view
		...
		{
			string fname = @"C:\temp\Authors.csv";string strAuthor = $"{pAuthor.AuthorID},{pAuthor.AuthorName},{pAuthor.NoOfBookPublished},{pAuthor.Royalty},{pAuthor.DOB}";
