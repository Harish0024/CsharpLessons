...
namespace Day6.NewFolder
{
    internal class Generic
    {
        ...
        {
            SortedSet<string> My = new SortedSet<string>();
            My.Add("harish");
            My.Add("Alpha");
            My.Add("nimal");
            My.Add("Nimal");
            foreach(string j  in My)
            {
                Console.WriteLine(j); 
            }
            HashSet<int> My2 = new HashSet<int>();
            My2.Add(1);
            My2.Add(1);
            My2.Add(1);
            My2.Add(1);
            foreach(int j in My2)
            {
                Console.WriteLine(j);
            }
        ...
        
        {
            ...
            Emp e1 = new Emp() { ID =1, Name = "Venkat", Salary = 10000 };
