...
namespace Lesson29._08.New
{
    internal class ParametersDemo
    {
        ...
        public static void AddIntParameters(params string[] king)
        {
            string add = string.Empty;
            Console.WriteLine("Param Length " + king.Length);
            foreach (string argu in king)
            {
                add += argu;
            }
        ...
        {
            AddIntParameters("Har");
            AddIntParameters("hav","jj","nimal");
        }
